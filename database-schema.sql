...
CREATE TABLE public.job_alerts (
    ...
    CONSTRAINT "FK_job_alerts_categories_CategoryId" FOREIGN KEY ("CategoryId") REFERENCES public.categories ("Id"),
    CONSTRAINT "FK_job_alerts_users_UserId" FOREIGN KEY ("UserId") REFERENCES public.users ("Id") ON DELETE CASCADE
);
...
CREATE TABLE public.notifications (
    ...
    CONSTRAINT "FK_notifications_job_applications_JobApplicationId" FOREIGN KEY ("JobApplicationId") REFERENCES public.job_applications ("Id"),
    CONSTRAINT "FK_notifications_jobs_JobId" FOREIGN KEY ("JobId") REFERENCES public.jobs ("Id"),
    CONSTRAINT "FK_notifications_users_UserId" FOREIGN KEY ("UserId") REFERENCES public.users ("Id") ON DELETE CASCADE
);
...
CREATE INDEX "IX_job_alerts_CategoryId" ON public.job_alerts ("CategoryId");


CREATE INDEX "IX_job_alerts_UserId" ON public.job_alerts ("UserId");
...
CREATE INDEX "IX_notifications_JobApplicationId" ON public.notifications ("JobApplicationId");


CREATE INDEX "IX_notifications_JobId" ON public.notifications ("JobId");
