...
public class WorkFinderContext : IdentityDbContext<ApplicationUser, IdentityRole<int>, int>
{
    ...
    private static readonly string connectionString = "Host=localhost;Database=workfinder;Username=postgres;Password=@Lam2004;Port=5432";
    ...
    {
        WorkFinderContext workFinderContext = new WorkFinderContext();
        String databasename = workFinderContext.Database.GetDbConnection().Database;// mydata
        bool result = workFinderContext.Database.EnsureCreated();
